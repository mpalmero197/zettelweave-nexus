...
// Lazy-load every heavy feature component ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ each is only mounted when its tab/dialog activates
...
const Index = () => {
  ...
  return (
    <>
      ...
      {/* Dialogs and Popovers (all lazy-loaded ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ wrap in Suspense) */}
