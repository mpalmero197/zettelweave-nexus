      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              THE SERVICE IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE. HALCYON SYSTEMS GROUP EXPRESSLY DISCLAIMS ALL WARRANTIES, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, ERROR-FREE, OR FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL HALCYON SYSTEMS GROUP, ITS AFFILIATES, DIRECTORS, OFFICERS, EMPLOYEES, AGENTS, PARTNERS, LICENSORS, OR SUPPLIERS BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES, INCLUDING BUT NOT LIMITED TO:
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              THIS LIMITATION APPLIES REGARDLESS OF THE THEORY OF LIABILITY (WHETHER BASED ON WARRANTY, CONTRACT, STATUTE, TORT, NEGLIGENCE, STRICT LIABILITY, OR ANY OTHER LEGAL THEORY) AND EVEN IF HALCYON SYSTEMS GROUP HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              You acknowledge and agree that Halcyon Systems Group shall not be held liable for any loss, corruption, or destruction of data, notes, documents, or any other information stored on or through the Service. You are solely responsible for maintaining backup copies of any data you store on the Service. We strongly recommend that you regularly export and backup your data to external storage systems.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Halcyon Systems Group is not responsible for any misuse of the Service by you or any third party. You agree to use the Service only for lawful purposes and in accordance with these Terms. You are solely responsible for all activities that occur under your account and for the content you create, upload, or share through the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              You and Halcyon Systems Group agree that any dispute, claim, or controversy arising out of or relating to these Terms or the Service (collectively, "Disputes") will be resolved exclusively through final and binding arbitration, rather than in court.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
              <strong className="text-foreground">Waiver of Right to Sue:</strong> BY AGREEING TO THESE TERMS, YOU EXPRESSLY WAIVE YOUR RIGHT TO BRING ANY CLAIMS AGAINST HALCYON SYSTEMS GROUP, ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, PARTNERS, LICENSORS, OR SUPPLIERS IN ANY COURT OF LAW. You agree that any Disputes shall be resolved solely through binding arbitration as set forth herein.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
              <strong className="text-foreground">Class Action Waiver:</strong> YOU AND HALCYON SYSTEMS GROUP AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, COLLECTIVE, OR REPRESENTATIVE ACTION. Unless both you and Halcyon Systems Group agree otherwise, the arbitrator may not consolidate more than one person's claims and may not otherwise preside over any form of representative or class proceeding.
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              These Terms, together with our Privacy Policy, constitute the entire agreement between you and Halcyon Systems Group regarding your use of the Service and supersede all prior agreements, understandings, and communications, whether written or oral.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              If you have any questions about these Terms, please contact Halcyon Systems Group at the contact information provided on our website.
            </p>
          </section>
        </div>
      </div>
