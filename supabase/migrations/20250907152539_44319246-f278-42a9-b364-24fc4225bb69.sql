...
-- Fix the existing update_updated_at_column function by dropping and recreating with CASCADE
...
-- Now fix the other functions with proper search_path settings
